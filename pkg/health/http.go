...
// HTTPGetInterface is an abstract interface for testabillity. It abstracts the interface of http.Client.Get.
...
// getURLParts parses the components the target URL.  For testabillity.
...
// formatURL formats a URL from args.  For testabillity.
