...
type PodInfoGetter interface {
	...
	// Return an api.PodInfo, or an error if one occurs.
...
// FakePodInfoGetter is a fake impelementation of PodInfoGetter. It is useful for testing.
type FakePodInfoGetter struct {
	data api.PodInfo
	err  error
}

// GetPodInfo is a fake impelementation of PodInfoGetter.GetPodInfo.
