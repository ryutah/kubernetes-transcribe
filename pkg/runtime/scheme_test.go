...
func TestExtensionMapping(t *testing.T) {
	...
	table := []struct {
		...
		{
			obj: &InternalExtensionType{
				Extension: runtime.EmbeddedObject{
					Object: &ExtensionA{TestString: "foo"},
				},
			},
			encoded: `{"kind":"ExtensionType","apiVersion":"testExternal","extension":{"kind":"A","testString":"foo"}}`,
		},
		{
			obj: &InternalExtensionType{
				Extension: runtime.EmbeddedObject{
					Object: &ExtensionB{TestString: "bar"},
				},
			},
			encoded: `{"kind":"ExtensionType","apiVersion":"testExternal","extension":{"kind":"B","testString":"bar"}}`,
		},
		{
			obj: &InternalExtensionType{
				Extension: runtime.EmbeddedObject{},
			},
			encoded: `{"kind":"ExtensionType","apiVersion":"testExternal","extension":null}`,
		},
	}
