...
// EmbeddedObject must have an appropriate encoder and decoder functions, such that a the
...
// recursively, such that API object of types known only at run time can be
// embedded within other API types.
*/

// UnmarshalJSON implements the json.Unmarshaller interfece.
